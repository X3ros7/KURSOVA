...
namespace Kursova
{
    public partial class MainForm : Form
    {
        ...
        private void автомобільToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void аксесуарToolStripMenuItem_Click(object sender, EventArgs e)
        {
            OnAddButtonClick("accessory", accessoryFields);
        }

        private void записНаТестдрайвToolStripMenuItem_Click(object sender, EventArgs e)
        {
            OnAddButtonClick("test_drive_record", testDriveRecordFields);
        }

        private void придбанняАвтоToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            OnAddButtonClick("vehicle_fee", vehicleFeeFields);
        }

        private void придбанняАксесуаруToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            OnAddButtonClick("accessory_fee", accessoryFeeFields);
        }

        private void лізингАвтоToolStripMenuItem_Click(object sender, EventArgs e)
        {
